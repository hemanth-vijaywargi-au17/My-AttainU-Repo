...
cvvField.addEventListener("focusin", e => {
    cardBox.style.transform = "perspective(800px) rotateY(180deg)";
    cardBox2.style.transform = "perspective(800px) rotateY(180deg)";
    cardBox2.style.zIndex = "1";
    cardBox.style.zIndex = "0";
})

cvvField.addEventListener("focusout", e => {
    cardBox.style.transform = "perspective(800px) rotateY(0deg)";
    cardBox2.style.transform = "perspective(800px) rotateY(0deg)";
